...
public class EnrichmentTask extends AbstractTask implements ObservableTask {
    ...
    public EnrichmentTask(final CyServiceRegistrar registrar, CytoPanelComponent2 enrichmentPanel) {
        ...
        this.nodesToFilterBy = new ListMultipleSelection<CyNode>(network.getNodeList());
        this.nodesToFilterBy.setSelectedValues(CyTableUtil.getNodesInState(network, CyNetwork.SELECTED, true));
